...
func (s *Server) Start() error {
	...
	fmt.Println("============================================================")
	fmt.Println("FastHTTP WebSocket Server (v1.5.10)")
	fmt.Println("============================================================")
	fmt.Printf("Port: %s\n", s.port)
	if s.enableLogging {
	...
	fmt.Println()
	if s.enableLogging {
		fmt.Printf("Throughput metrics logged to: data/raw/throughput_golang_fasthttp.csv\n")
		fmt.Printf("Resource metrics logged to: data/raw/resources_golang_fasthttp.csv\n")
	}
	fmt.Println("Press Ctrl+C to stop")
	fmt.Println("============================================================")
	fmt.Println()

	s.logger.Log(fmt.Sprintf("FastHTTP WebSocket server listening on port %s", s.port))

	return fasthttp.ListenAndServe(":"+s.port, s.handleRequest)
}
...
func (s *Server) handleWebSocket(ctx *fasthttp.RequestCtx) {
